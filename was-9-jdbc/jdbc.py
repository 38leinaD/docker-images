...
AdminTask.createDatasource(oracleXA, '[-name %s -jndiName %s -dataStoreHelperClassName com.ibm.websphere.rsadapter.Oracle11gDataStoreHelper -containerManagedPersistence %s -componentManagedAuthenticationAlias %s -configureResourceProperties [[URL java.lang.String %s]]]'%('ORACLE', 'ORACLE', 'false', oracleCredentials, 'jdbc:oracle:thin:@oracle:1521/XE'))
